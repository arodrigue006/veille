    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="container">
                ...
                <p>
                    Tout d'abord Three.js est open-source, nous pouvons donc facilement regarder le code source 
                    et comprendre les fonctionnalités du code.
                    <p>Comme on a pu le voir précédemment Three.js utilise la technologie WebGL pour les graphiques 
                        qui ne prend pas en charge la plupart des navigateurs, mais Three.js quant à lui prend en 
                        charge la plupart des navigateurs, là est toute la différence.
                    Sans parler du fait que par exemple faire un carré en WebGL demande des dizaines de lignes tandis 
                    que faire un cube texturé en Three : 5 lignes, autrement dit cela simplifie grandement le code et 
                    donc une utilisation plus agréable.
</p>
De plus, cela ne nécessite aucun plugin tiers pour exécuter le code. Il vous suffit de travailler sur 
un seul langage de programmation JavaScript et bien sûr HTML.
                </p>
                <p> Le prix de three.js est de 0 euros par utilisateur et par mois (ce logiciel dispose 
                    d’une version d’essai gratuite), seules quelques fonctionnalités 
                    facultatives(où je ne me pencherai pas ici) peuvent être payantes.
                </p>
                <p> Enfin Three.js dispose d'une grande communauté, les avis en ligne sur le 
                    logiciel sont assez nombreux et positifs dans l’ensemble.
                    C'est donc une solution robuste. Elle a fait ses preuves, près d’une décennie. 
                    De nombreuses ressources peuvent être trouvées (en plus de la documentation officielle).
                </p>
